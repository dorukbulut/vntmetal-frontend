  ...
  return (
    <>
      <div
        className={
          isOpen
            ? "absolute bg-white w-3/5 md:w-1/3 lg:w-1/5 h-screen z-40   p-5 translate-x-0 ease-in-out duration-300"
            : "fixed z-40 top-0 left-0  h-screen -translate-x-full ease-in-out duration-100 p-5"
        }
      >
        <div className={!isOpen ? "pl-10 absolute " : "hidden"}>
          <svg
            ...
            viewBox="0 0 24 24"
            strokeWidth={1.5}
            className="hover:cursor-pointer stroke-sky-700 justify-self-end w-6 h-6"
          >
            <path
              strokeLinecap="round"
        ...
        <div
          className={
            isOpen ? "flex flex-col space-y-10 items-start " : "hidden"
          }
        >
          <div className="grid ease-in-out">
            <svg
              ...
              viewBox="0 0 24 24"
              strokeWidth={1.5}
              className="hover:cursor-pointer hover:bg-gray-300 stroke-sky-700 justify-self-end w-6 h-6"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <div className="flex items-center space-x-5 border-solid border-b-2 p-2">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="stroke-sky-700 w-6 h-6"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              <div className="flex flex-col lg:text-xs text-xs mb-10 ">
                <div className="flex items-center w-full">
                  ...
                  <ChevronDownIcon
                    onClick={toggleQuotation}
                    className={`-mr-1 ml-2 h-5 w-5 ${
                      quotation ? "rotate-180" : "rotate-0"
                    } ease-in-out duration-300 hover:cursor-pointer`}
                    aria-hidden="true"
                  />
                </div>
                <div
                  className={`flex flex-col w-full justify-self-end items-end space-y-2 ${
                    quotation
                      ? "visible  scale-100 "
                      : "invisible transform scale-0 h-0"
                  } transition duration-300 ease-in-out origin-top`}
