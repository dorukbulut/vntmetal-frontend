       ...
       <div className={isOpen ? "border border-r-2 border-solid absolute w-3/5 md:w-1/3 lg:w-1/5 h-screen bg-gray-100 z-40  p-5 translate-x-0 ease-in-out duration-300" :"fixed z-40 top-0 left-0  h-screen -translate-x-full ease-in-out duration-100 p-5"}>
          ...
          <div className={isOpen ? "flex flex-col space-y-10 items-start" : "hidden"}>
            ...
            <div className='flex items-center space-x-5'>
              ...
              <p className="font-poppins text-xs text-sky-700 tracking-widest">VNT METAL DYS</p>
              <hr/>
            </div>
            ...
            <div className='flex flex-col space-y-5 items-end '>
                <div className='flex items-center space-x-5'>
                  <svg  fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="stroke-sky-700 w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p className="font-poppins text-xs text-sky-700 tracking-widest">Sipariş Modülü</p>
                ...
                <div className={`space-y-6 tracking-widest font-poppins text-sm text-sky-600 ${sales? "visible" : "invisible"} transition ease-out delay-3000`}>
