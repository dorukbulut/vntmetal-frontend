...
import ReportGeneralService from "../../../services/ReportGeneralService";
export default function Page() {
    ...
    const {dat11} = useSWR(() => {
        ReportGeneralService.getCustomerReport()
            .then(res => {
                if (res.status === 200){
                    setData(res.data)
                }
                    ...
                    <div className="flex flex-col p-5 space-y-5 border-2 rounded-lg">
                        ...
                        <div className="grid grid-cols-4 gap-10  p-2 rounded-lg ">
                            <TextField
                                ...
                                variant="standard"
                                value={data?.totalProductionKgs || 0}
                                label="Toplam Ocak ve Dökümhane malzeme ağırlığı  (Kg) "
                            />
                            <TextField
                                InputProps={{
                                    readOnly: true,
                                ...
                                variant="standard"
                                value={data?.totalProductionExtraKgs || 0}
                                label="Toplam Ocak ve dökümhane malzeme ağırlığı (extra-kg)"
                            />
                            ...
                            <TextField
                                ...
                                variant="standard"
                                value={data?.totalProductionUsages || 0}
                                label="Toplam Ocak ve Dökümhane Kullanımı"
                            />
                        ...
                        <div className="grid grid-cols-4 gap-10  p-2 rounded-lg ">
                            <TextField
                                ...
                                variant="standard"
                                value={data?.totalProcessKgs || 0}
                                label="Toplam İşlenen Ağırlık (kg)"
                            />
                            <TextField
                                InputProps={{
                                    readOnly: true,
                                ...
                                variant="standard"
                                value={data?.totalProcessUsages || 0}
                                label="Toplam Atölye kullanımı"
                            />
                            ...
                            <TextField
                                ...
                                variant="standard"
                                value={data?.totalShipmentKgs || 0}
                                label="Toplam Sevk edilen Ağırlık (kg)"
                            />
                            ...
                            <TextField
                                ...
                                variant="standard"
                                value={data?.totalShipmentUsages || 0}
                                label="Toplam Sevk (paket)"
                            />
